        ...
        <div className="prob_wrapper">
            <div className="prob_left" id="leftActiv">
                ...
                <div className="input_form">
                    <input placeholder="0" value={input} onChange={(e) => setInput(e.target.value)}/>
                ...
                <div className="dropdown">
                    ...
                    <button id='buttonChange' className="drop" onClick={handleClickLeft}>
